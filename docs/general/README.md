...
The name and icon to be displayed are set in the `public/manifest.json` generated by
Webpack's `webpack-pwa-manifest` plugin. Configure the name, colors, and icons
in `config/webpack.config.js` and try it!
